...
export default function GlobalRecipesPage() {
  ...
  // ZAP SAUCE GLOBAL - 19 RECIPES ONLY - M2500 ONCE-OFF
  const globalRecipes = {
    'master-base': {
      id: 'master-base',
  ...
  if (!recipe) {
    return (
      <div style={{ padding: '40px', textAlign: 'center', background: '#0a0a0a', color: '#fff', minHeight: '100vh' }}>
        ...
        <Link href="/recipes" style={{ color: '#FFD700', textDecoration: 'none', fontWeight: '700' }}>
          ← Back to All Recipes
        </Link>
      </div>
    )
    ...
    <div style={{ background: '#0a0a0a', color: '#fff', minHeight: '100vh', padding: '20px' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px', paddingTop: '40px' }}>
          <Link href="/recipes" style={{ color: '#FFD700', textDecoration: 'none', fontSize: '0.9rem' }}>
            ← All Recipes
          </Link>
        ...
        <div style={{ 
          ...
          <p style={{ color: '#ccc', margin: '0 0 16px 0', fontSize: '0.95rem' }}>NOT RESELLABLE. Personal empire use only. Master Base + 18 Signature Recipes. Global ingredients.</p>
          <a 
        ...
        <div style={{ textAlign: 'center', padding: '40px 0', borderTop: '1px solid #1f1f1f' }}>
          ...
          <Link href="/recipes" style={{ color: '#FFD700', textDecoration: 'none', fontWeight: '700', marginTop: '16px', display: 'inline-block' }}>
            ← Back to All Recipes
          </Link>
        </div>
