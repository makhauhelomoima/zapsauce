...
export default function Home() {
  return (
    <main className="bg-black min-h-[100dvh] text-white flex flex-col px-2 py-0 relative overflow-hidden justify-between">
      ...
      {/* SPACER TOP - Forces content down from top */}
      <div className="h-12"></div>

      {/* CONTENT - STRETCHED TO FILL */}
      <div className="flex-1 flex flex-col justify-around items-center text-center relative z-10 w-full py-4">

        {/* TOP SECTION */}
        <div className="w-full">
          <h1 className="text-8xl font-black text-[#00E06D] mb-4 drop-shadow-[0_0_60px_rgba(0,224,109,1)] leading-[0.9]">
            Zap Sauce.
          </h1>

          <p className="text-4xl text-[#00C85F] mb-3 font-black leading-tight">Immunity in a jar! ⚡</p>
          <p className="text-2xl text-gray-50 mb-2 font-bold leading-tight px-2">What hurts? We have a recipe for that.</p>
          ...
          <p className="text-base text-gray-400 mb-8 leading-snug px-4 font-medium">
        ...
        <div className="w-full px-1">
          <div className="flex flex-col gap-4 justify-center mb-8">
            ...
            <Link
              href="/portal"
              className="border-3 border-[#00A651] text-[#00C85F] hover:bg-[#00A651] hover:text-white font-black px-6 py-7 rounded-2xl text-3xl transition-all"
            >
              Customer Portal
            </Link>
          </div>
        ...
        {/* BOTTOM SECTION - PDF + FOOTER */}
        <div className="w-full">
          <div className="bg-gray-900 border-3 border-[#00A651] rounded-2xl p-6 mb-6 backdrop-blur shadow-2xl shadow-green-500/60">
          ...
          <div className="text-base text-gray-300 font-semibold pb-2">
      ...
      {/* SPACER BOTTOM - Forces content up from bottom */}
