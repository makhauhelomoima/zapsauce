    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-gray-100">
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-gradient-to-br from-amber-50 to-yellow-100 rounded-2xl shadow-2xl p-8 border-2 border-amber-400 hover:scale-105 transition duration-300">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold mb-4 text-amber-900">Gold Luxury Boutique</h2>
              <p className="text-amber-800 mb-2 font-medium">Luxury Wall Art</p>
              <p className="text-5xl font-bold mb-6 text-amber-950">M199</p>
          ...
          <div className="bg-gradient-to-br from-emerald-50 to-green-100 rounded-2xl shadow-2xl p-8 border-2 border-emerald-500 hover:scale-105 transition duration-300">
            <div className="text-center">
              ...
              <p className="text-emerald-800 mb-2 font-medium">Lightning in a Jar</p>
              <p className="text-5xl font-bold mb-6 text-emerald-950">M150</p>
        ...
        <div className="bg-gradient-to-r from-gray-900 to-black text-white rounded-2xl p-12 text-center mb-16 shadow-2xl border border-amber-500">
          ...
          <p className="text-xl mb-2">M60 per Gold Luxury Boutique M199 sale</p>
          <p className="text-xl mb-8">M45 per Zap Sauce M150 sale</p>
          <p className="mb-8 text-gray-300">One dashboard. Two products. Weekly M-Pesa payouts.</p>
        ...
        <div className="bg-amber-50 border-l-4 border-amber-500 p-6 rounded-xl mb-16 shadow-md">
          ...
          <p className="text-amber-800">We've upgraded! Choose from the Gold Luxury Boutique collection for <strong>M199</strong> or get Zap Sauce for <strong>M150</strong> above. Same lightning, more gold 🤍</p>
        </div>
